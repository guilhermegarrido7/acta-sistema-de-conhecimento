# Análise de Aderência e Seleção de ERP

Seleção de ERP: levantamento de requisitos, matriz de aderência, RFP, avaliação de fornecedores e business case de implantação.
