# Modelos de Operações Inteligentes

Desenho de modelos de operação apoiados em automação e analytics: identificação de casos, redesenho do processo e modelo operacional alvo.
